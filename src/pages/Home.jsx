        ...
        <div className="bg-yellow-50">
            <div className="">
                {/* <ImageSlider></ImageSlider> */}
                 ...
                 <img className="w-full  h-[80vh] mx-auto" src="https://i.ibb.co/6ZqDhtR/palki2.png" alt="" />
            </div>
            <div>
                <h2 className=" text-2xl md:text-3xl font-bold p-2 rounded-sm text-white bg-pink-600 md:w-1/4">Our Services</h2>
            </div>
